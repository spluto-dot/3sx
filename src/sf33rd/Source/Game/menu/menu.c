...
void Load_Replay_Sub(struct _TASK* task_ptr) {
    ...
    case 1:
        ...
        for (ix = 0; ix < 2; ix++) {
            ps.plw[ix].wu.operator = Replay_w.game_infor.player_infor[ix].player_type;
...
s32 Pause_1st_Sub(struct _TASK* task_ptr) {
    ...
    if (sw & SWK_START) {
        if (((Mode_Type == MODE_NORMAL_TRAINING) || (Mode_Type == MODE_PARRY_TRAINING)) &&
            (Check_Pause_Term_Tr(Pause_ID ^ 1) != 0) && ps.plw[Pause_ID ^ 1].wu.operator &&
    ...
    case 1:
        ...
        case 0x100:
            ...
            case 2:
                ...
                init_omop();
                set_init_A4_flag();
                setup_vitality(&ps.plw[0].wu, My_char[0] + 0);
                setup_vitality(&ps.plw[1].wu, My_char[1] + 0);
                Setup_Training_Difficulty();
