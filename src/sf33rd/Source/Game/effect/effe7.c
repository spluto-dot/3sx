...
void effe7_get_zanzou_data(WORK_Other* ewk) {
    ewk->wu.position_x = ps.zanzou_table[ewk->master_id]->pos_x;
    ewk->wu.position_y = ps.zanzou_table[ewk->master_id]->pos_y;
    ewk->wu.position_z = ps.zanzou_table[ewk->master_id]->pos_z;
    ewk->wu.cg_number = ps.zanzou_table[ewk->master_id]->cg_num;
    ewk->wu.rl_flag = ps.zanzou_table[ewk->master_id]->flip;
    ewk->wu.cg_flip = ps.zanzou_table[ewk->master_id]->cg_flp;
}
