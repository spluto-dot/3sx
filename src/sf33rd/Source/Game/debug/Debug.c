...
void Disp_Random() {
    ...
    if (Debug_w[0x3B]) {
        ...
        flPrintL(20, offset_y + 32, "%4X", ps.plw[0].wu.position_x);
        flPrintL(20, offset_y + 33, "%4X", ps.plw[0].wu.position_y);
        flPrintL(20, offset_y + 34, "%4X", ps.plw[1].wu.position_x);
        flPrintL(20, offset_y + 35, "%4X", ps.plw[1].wu.position_y);
