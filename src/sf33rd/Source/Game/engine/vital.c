...
void vital_control(u8 pl) {
    if (ps.plw[pl].wu.vital_new < 0xA1) {
        if ((vit[pl].cyerw == ps.plw[pl].wu.vital_new) && (vit[pl].cred == ps.plw[pl].wu.vital_new) &&
            (vit[pl].ored != (ps.plw[pl].wu.vital_new + 1))) {
            if (No_Trans == 0) {
        ...
        if (vit[pl].cred < ps.plw[pl].wu.vital_new) {
            vit[pl].cred = ps.plw[pl].wu.vital_new;
        }

        vit[pl].cyerw = ps.plw[pl].wu.vital_new;

        if (ps.plw[pl].wu.vital_new < 0) {
            vit[pl].cyerw = 0;
        }

        if (ps.plw[pl].wu.vital_new == 0xA0) {
            vit[pl].colnum = 1;
        } else if (ps.plw[pl].wu.vital_new < 0x31) {
            vit[pl].colnum = 3;
        } else {
            vit[pl].colnum = 2;
        }
