...
glabel func_0035BC88
    ...
    /* 25BD0C 0035BC8C 4300023C */  lui        $v0, %hi(D_42C320)
    /* 25BD10 0035BC90 4000B2FF */  sd         $s2, 0x40($sp)
    /* 25BD14 0035BC94 4300123C */  lui        $s2, %hi(D_42C324)
    /* 25BD18 0035BC98 3000B0FF */  sd         $s0, 0x30($sp)
    /* 25BD1C 0035BC9C 2D808000 */  daddu      $s0, $a0, $zero
    /* 25BD20 0035BCA0 3800B1FF */  sd         $s1, 0x38($sp)
    /* 25BD24 0035BCA4 4300033C */  lui        $v1, %hi(D_42C37C)
    /* 25BD28 0035BCA8 4800BFFF */  sd         $ra, 0x48($sp)
    /* 25BD2C 0035BCAC 20C34224 */  addiu      $v0, $v0, %lo(D_42C320)
    /* 25BD30 0035BCB0 24C3458E */  lw         $a1, -0x3CDC($s2)
    /* 25BD34 0035BCB4 7CC36324 */  addiu      $v1, $v1, %lo(D_42C37C)
    ...
    /* 25BD44 0035BCC4 24C34326 */   addiu     $v1, $s2, %lo(D_42C324)
    ...
    /* 25BD78 0035BCF8 4300113C */  lui        $s1, %hi(D_42C330)
    /* 25BD7C 0035BCFC 18000224 */  addiu      $v0, $zero, 0x18
    /* 25BD80 0035BD00 30C32426 */  addiu      $a0, $s1, %lo(D_42C330)
  ...
  .L0035BD38:
    /* 25BDB8 0035BD38 4300113C */  lui        $s1, %hi(D_42C330)
    /* 25BDBC 0035BD3C 30C32426 */  addiu      $a0, $s1, %lo(D_42C330)
  ...
  .L0035BD6C:
    ...
    /* 25BDF0 0035BD70 4300103C */   lui       $s0, %hi(D_42C3C8)
    /* 25BDF4 0035BD74 C8C31026 */  addiu      $s0, $s0, %lo(D_42C3C8)
    ...
    /* 25BE08 0035BD88 4300033C */  lui        $v1, (0x433C58 >> 16)
    /* 25BE0C 0035BD8C 1800A28F */  lw         $v0, 0x18($sp)
    /* 25BE10 0035BD90 F26D0D0C */  jal        func_0035B7C8
    /* 25BE14 0035BD94 583C62AC */   sw        $v0, (0x433C58 & 0xFFFF)($v1)
    ...
    /* 25BE34 0035BDB4 30C32226 */  addiu      $v0, $s1, %lo(D_42C330)
    ...
    /* 25BE54 0035BDD4 24C34326 */  addiu      $v1, $s2, %lo(D_42C324)
  .L0035BDD8:
...
glabel func_0035BE00
    /* 25BE80 0035BE00 4300033C */  lui        $v1, %hi(D_42C3D8)
    /* 25BE84 0035BE04 4300043C */  lui        $a0, %hi(D_42C3E8)
    /* 25BE88 0035BE08 4300053C */  lui        $a1, %hi(D_42C3F8)
    /* 25BE8C 0035BE0C 4300063C */  lui        $a2, %hi(D_42C408)
    /* 25BE90 0035BE10 4300073C */  lui        $a3, %hi(D_42C418)
    /* 25BE94 0035BE14 4300083C */  lui        $t0, %hi(D_42C428)
    /* 25BE98 0035BE18 01000224 */  addiu      $v0, $zero, 0x1
    /* 25BE9C 0035BE1C D8C36324 */  addiu      $v1, $v1, %lo(D_42C3D8)
    /* 25BEA0 0035BE20 E8C38424 */  addiu      $a0, $a0, %lo(D_42C3E8)
    /* 25BEA4 0035BE24 F8C3A524 */  addiu      $a1, $a1, %lo(D_42C3F8)
    /* 25BEA8 0035BE28 08C4C624 */  addiu      $a2, $a2, %lo(D_42C408)
    /* 25BEAC 0035BE2C 18C4E724 */  addiu      $a3, $a3, %lo(D_42C418)
    /* 25BEB0 0035BE30 28C40825 */  addiu      $t0, $t0, %lo(D_42C428)
...
glabel func_0035BE50
    ...
    /* 25BED4 0035BE54 4300033C */  lui        $v1, %hi(D_42C324)
    /* 25BED8 0035BE58 0000BFFF */  sd         $ra, 0x0($sp)
    /* 25BEDC 0035BE5C 24C36324 */  addiu      $v1, $v1, %lo(D_42C324)
    ...
    /* 25BF18 0035BE98 4300023C */  lui        $v0, %hi(D_42C3C8)
    /* 25BF1C 0035BE9C 4300033C */  lui        $v1, (0x433C58 >> 16)
    /* 25BF20 0035BEA0 C8C34224 */  addiu      $v0, $v0, %lo(D_42C3C8)
    /* 25BF24 0035BEA4 583C658C */  lw         $a1, (0x433C58 & 0xFFFF)($v1)
