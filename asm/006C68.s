...
glabel func_00106BE8
    /* 6C68 00106BE8 3E00023C */  lui        $v0, (0x3E7680 >> 16)
    /* 6C6C 00106BEC C0FFBD27 */  addiu      $sp, $sp, -0x40
    /* 6C70 00106BF0 8076438C */  lw         $v1, (0x3E7680 & 0xFFFF)($v0)
  ...
  .L00106C08:
    ...
    /* 6C8C 00106C0C 3E00023C */  lui        $v0, (0x3E7678 >> 16)
    /* 6C90 00106C10 1818A300 */  mult       $v1, $a1, $v1
    /* 6C94 00106C14 5000043C */  lui        $a0, %hi(D_4FE3C0)
    /* 6C98 00106C18 787645AC */  sw         $a1, (0x3E7678 & 0xFFFF)($v0)
  ...
  .L00106C84:
    ...
    /* 6D14 00106C94 4600023C */   lui       $v0, %hi(jtbl_00459B60_main)
    /* 6D18 00106C98 80180400 */  sll        $v1, $a0, 2
    /* 6D1C 00106C9C 609B4224 */  addiu      $v0, $v0, %lo(jtbl_00459B60_main)
  ...
  .L00106F1C:
    ...
    /* 6FA0 00106F20 3E00073C */   lui       $a3, (0x3E75F8 >> 16)
    /* 6FA4 00106F24 23100400 */  negu       $v0, $a0
    /* 6FA8 00106F28 F875E38C */  lw         $v1, (0x3E75F8 & 0xFFFF)($a3)
    ...
    /* 6FC0 00106F40 F875E2AC */  sw         $v0, (0x3E75F8 & 0xFFFF)($a3)
  ...
  .L00106F54:
    ...
    /* 6FDC 00106F5C F875E224 */   addiu     $v0, $a3, %lo(D_3E75F8)
...
glabel func_00106FA0
    ...
    /* 702C 00106FAC 3E00103C */  lui        $s0, (0x3E7684 >> 16)
    /* 7030 00106FB0 3000BFFF */  sd         $ra, 0x30($sp)
    /* 7034 00106FB4 8476028E */  lw         $v0, (0x3E7684 & 0xFFFF)($s0)
    ...
    /* 7058 00106FD8 847602AE */  sw         $v0, (0x3E7684 & 0xFFFF)($s0)
...
glabel func_00106FF0
    ...
    /* 7080 00107000 3E00023C */  lui        $v0, (0x3E7684 >> 16)
    /* 7084 00107004 F80B040C */  jal        func_00102FE0
    /* 7088 00107008 8476448C */   lw        $a0, (0x3E7684 & 0xFFFF)($v0)
...
glabel func_00107020
    /* 70A0 00107020 3E00023C */  lui        $v0, (0x3E7684 >> 16)
    /* 70A4 00107024 F00B0408 */  j          func_00102FC0
    /* 70A8 00107028 8476448C */   lw        $a0, (0x3E7684 & 0xFFFF)($v0)
...
glabel func_00107030
    ...
    /* 70E4 00107064 3E00023C */  lui        $v0, (0x3E767C >> 16)
    /* 70E8 00107068 7C76438C */  lw         $v1, (0x3E767C & 0xFFFF)($v0)
