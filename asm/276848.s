...
glabel func_003767C8
    ...
    /* 276860 003767E0 4E00023C */  lui        $v0, (0x4E0000 >> 16)
    /* 276864 003767E4 21104700 */  addu       $v0, $v0, $a3
    /* 276868 003767E8 21DE4290 */  lbu        $v0, -0x21DF($v0)
    /* 27686C 003767EC 4E00033C */  lui        $v1, (0x4E0000 >> 16)
    /* 276870 003767F0 21186500 */  addu       $v1, $v1, $a1
    /* 276874 003767F4 21DE6390 */  lbu        $v1, -0x21DF($v1)
  ...
  .L00376818:
    ...
    /* 2768AC 0037682C 4E00023C */  lui        $v0, (0x4E0000 >> 16)
    /* 2768B0 00376830 21104600 */  addu       $v0, $v0, $a2
    /* 2768B4 00376834 21DE4290 */  lbu        $v0, -0x21DF($v0)
    /* 2768B8 00376838 4E00033C */  lui        $v1, (0x4E0000 >> 16)
    /* 2768BC 0037683C 21186500 */  addu       $v1, $v1, $a1
    /* 2768C0 00376840 21DE6390 */  lbu        $v1, -0x21DF($v1)
  ...
  .L00376864:
    ...
    /* 2768E8 00376868 4E00043C */  lui        $a0, (0x4E0000 >> 16)
    /* 2768EC 0037686C 21208500 */  addu       $a0, $a0, $a1
    /* 2768F0 00376870 21DE8490 */  lbu        $a0, -0x21DF($a0)
    /* 2768F4 00376874 2000A724 */  addiu      $a3, $a1, 0x20
    /* 2768F8 00376878 4E00033C */  lui        $v1, (0x4E0000 >> 16)
    /* 2768FC 0037687C 21186200 */  addu       $v1, $v1, $v0
    /* 276900 00376880 21DE6390 */  lbu        $v1, -0x21DF($v1)
