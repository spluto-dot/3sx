...
glabel func_00110BB8
  ...
  .L00110C08:
    /* 10C88 00110C08 3F00153C */  lui        $s5, %hi(D_003EA88C)
    /* 10C8C 00110C0C FC0B040C */  jal        func_00102FF0
    /* 10C90 00110C10 8CA8A48E */   lw        $a0, %lo(D_003EA88C)($s5)
  ...
  .L00110C30:
    ...
    /* 10CB4 00110C34 8CA8A48E */   lw        $a0, %lo(D_003EA88C)($s5)
  ...
  .L00110C40:
    ...
    /* 10D30 00110CB0 3F00033C */   lui       $v1, %hi(D_003EA888)
    /* 10D34 00110CB4 0C000224 */  addiu      $v0, $zero, 0xC
    /* 10D38 00110CB8 03000010 */  b          .L00110CC8
    /* 10D3C 00110CBC 88A862AC */   sw        $v0, %lo(D_003EA888)($v1)
  .L00110CC0:
    /* 10D40 00110CC0 F00B040C */  jal        func_00102FC0
    /* 10D44 00110CC4 8CA8A48E */   lw        $a0, %lo(D_003EA88C)($s5)
  .L00110CC8:
...
glabel func_00110CF8
  ...
  .L00110D30:
    /* 10DB0 00110D30 3F00133C */  lui        $s3, %hi(D_003EA88C)
    /* 10DB4 00110D34 FC0B040C */  jal        func_00102FF0
    /* 10DB8 00110D38 8CA8648E */   lw        $a0, %lo(D_003EA88C)($s3)
  ...
  .L00110D4C:
    ...
    /* 10E0C 00110D8C 3F00033C */   lui       $v1, %hi(D_003EA888)
    /* 10E10 00110D90 10000224 */  addiu      $v0, $zero, 0x10
    /* 10E14 00110D94 03000010 */  b          .L00110DA4
    /* 10E18 00110D98 88A862AC */   sw        $v0, %lo(D_003EA888)($v1)
  .L00110D9C:
    /* 10E1C 00110D9C F00B040C */  jal        func_00102FC0
    /* 10E20 00110DA0 8CA8648E */   lw        $a0, %lo(D_003EA88C)($s3)
  .L00110DA4:
