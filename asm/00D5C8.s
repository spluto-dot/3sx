...
glabel func_0010D548
    ...
    /* D5F0 0010D570 3F00023C */   lui       $v0, %hi(D_3E8C88)
  .L0010D574:
  ...
  .L0010D580:
    /* D600 0010D580 888C4224 */  addiu      $v0, $v0, %lo(D_3E8C88)
...
glabel func_0010D660
    ...
    /* D720 0010D6A0 3F00023C */   lui       $v0, %hi(D_3E8C88)
    /* D724 0010D6A4 888C4224 */  addiu      $v0, $v0, %lo(D_3E8C88)
