...
glabel func_0010C178
    ...
    /* C1FC 0010C17C 3E00023C */  lui        $v0, %hi(D_003E7D00)
    ...
    /* C224 0010C1A4 007D5024 */  addiu      $s0, $v0, %lo(D_003E7D00)
    /* C228 0010C1A8 6000B6FF */  sd         $s6, 0x60($sp)
    /* C22C 0010C1AC 007D448C */  lw         $a0, %lo(D_003E7D00)($v0)
    ...
    /* C278 0010C1F8 3E00163C */   lui       $s6, %hi(D_003E7CF8)
  ...
  .L0010C238:
    ...
    /* C2C4 0010C244 F87CD1AE */   sw        $s1, %lo(D_003E7CF8)($s6)
  .L0010C248:
    /* C2C8 0010C248 F87CD1AE */  sw         $s1, %lo(D_003E7CF8)($s6)
  .L0010C24C:
