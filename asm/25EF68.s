...
glabel func_0035F020
    /* 25F0A0 0035F020 4300023C */  lui        $v0, %hi(D_0043467C)
    /* 25F0A4 0035F024 0800E003 */  jr         $ra
    /* 25F0A8 0035F028 7C4644AC */   sw        $a0, %lo(D_0043467C)($v0)
...
glabel func_0035F038
    ...
    /* 25F0EC 0035F06C 4300033C */  lui        $v1, %hi(D_00434678)
    /* 25F0F0 0035F070 450002A2 */  sb         $v0, 0x45($s0)
    /* 25F0F4 0035F074 78467124 */  addiu      $s1, $v1, %lo(D_00434678)
...
glabel func_0035F0D8
    /* 25F158 0035F0D8 4300023C */  lui        $v0, %hi(D_00435588)
    /* 25F15C 0035F0DC E0FFBD27 */  addiu      $sp, $sp, -0x20
    /* 25F160 0035F0E0 88554224 */  addiu      $v0, $v0, %lo(D_00435588)
    ...
    /* 25F184 0035F104 4300083C */  lui        $t0, %hi(D_00435594)
    /* 25F188 0035F108 4300043C */  lui        $a0, %hi(D_00435598)
    /* 25F18C 0035F10C 4300073C */  lui        $a3, %hi(D_00435595)
    /* 25F190 0035F110 98558424 */  addiu      $a0, $a0, %lo(D_00435598)
    /* 25F194 0035F114 4300033C */  lui        $v1, %hi(D_00435596)
    /* 25F198 0035F118 4300023C */  lui        $v0, %hi(D_00435597)
    /* 25F19C 0035F11C 96556324 */  addiu      $v1, $v1, %lo(D_00435596)
    /* 25F1A0 0035F120 2D288000 */  daddu      $a1, $a0, $zero
    /* 25F1A4 0035F124 E8000624 */  addiu      $a2, $zero, 0xE8
    /* 25F1A8 0035F128 94550825 */  addiu      $t0, $t0, %lo(D_00435594)
    /* 25F1AC 0035F12C 9555E724 */  addiu      $a3, $a3, %lo(D_00435595)
    /* 25F1B0 0035F130 97554224 */  addiu      $v0, $v0, %lo(D_00435597)
    /* 25F1B4 0035F134 00000991 */  lbu        $t1, 0x0($t0)
    /* 25F1B8 0035F138 0000EA90 */  lbu        $t2, 0x0($a3)
    /* 25F1BC 0035F13C 4E00103C */  lui        $s0, %hi(D_004DA868)
    /* 25F1C0 0035F140 00006890 */  lbu        $t0, 0x0($v1)
    /* 25F1C4 0035F144 68A81026 */  addiu      $s0, $s0, %lo(D_004DA868)
